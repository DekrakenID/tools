...
(function ()
{
    ...
    var FEATURE_INFOS =
    {
        ...
        LOCALE_INFINITY:
        {
            description: 'Language sensitive string representation of Infinity as "âˆž".',
            check:
            function ()
            {
                var available = Infinity.toLocaleString() === 'âˆž';
                return available;
            },
        },
        NAME:
     ...
     *
     * @typedef {JSDekrakenFuck.Feature|string} FeatureElement
     *
     * @throws {Error}
     ...
     * `new JSDekrakenFuck.Feature(feature1, feature2)` or `JSDekrakenFuck.Feature(feature1, feature2)`.
     * If no arguments are specified, the new feature object will be equivalent to
     * [`DEFAULT`](Features.md#DEFAULT).
     *
     * @class JSDekrakenFuck.Feature
     *
     ...
     *
     * ```js
     * new JSDekrakenFuck.Feature("ANY_DOCUMENT", "ANY_WINDOW");
     * ```
     *
     * ```js
     * new JSDekrakenFuck.Feature(JSDekrakenFuck.Feature.ANY_DOCUMENT, JSDekrakenFuck.Feature.ANY_WINDOW);
     * ```
     *
     * ```js
     * new JSDekrakenFuck.Feature([JSDekrakenFuck.Feature.ANY_DOCUMENT, JSDekrakenFuck.Feature.ANY_WINDOW]);
     ...
     *
     * @classdesc
     * Objects of this type indicate which of the capabilities that JSDekrakenFuck can use to minimize the
     * length of its output are available in a particular JavaScript engine.
     *
     * JSDekrakenFuck comes with a set of predefined feature objects exposed as property values of
     * `JSDekrakenFuck.Feature` or [`JSDekrakenFuck.Feature.ALL`](#JSDekrakenFuck.Feature.ALL), where the property
    ...
    var constructorSource =
    {
         ...
         *
         * @member {object} JSDekrakenFuck.Feature.ELEMENTARY
         */
         ...
         *
         * @function JSDekrakenFuck.Feature.areCompatible
         *
         ...
         * JSDekrakenFuck.Feature.areCompatible(["V8_SRC", "IE_SRC"])
         * ```
         *
         * ```js
         * // true
         * JSDekrakenFuck.Feature.areCompatible([JSDekrakenFuck.Feature.DEFAULT, JSDekrakenFuck.Feature.FILL])
         * ```
         */
         ...
         *
         * @function JSDekrakenFuck.Feature.areEqual
         *
         * @param {...(FeatureElement|CompatibleFeatureArray)} [feature]
         *
         * @returns {boolean}
         ...
         * ```js
         * // false
         * JSDekrakenFuck.Feature.areEqual(JSDekrakenFuck.Feature.CHROME, JSDekrakenFuck.Feature.FIREFOX)
         * ```
         *
         * ```js
         * // true
         * JSDekrakenFuck.Feature.areEqual("DEFAULT", [])
         * ```
         */
         ...
         *
         * @function JSDekrakenFuck.Feature.commonOf
         *
         * @param {...(FeatureElement|CompatibleFeatureArray)} [feature]
         *
         * @returns {JSDekrakenFuck.Feature|null}
         ...
         *
         * ```js
         * var newFeature = JSDekrakenFuck.Feature.commonOf(["ATOB", "NAME"], ["NAME", "SELF"]);
         * ```
         *
         ...
         *
         * ```js
         * var newFeature = JSDekrakenFuck.Feature.commonOf("HTMLDOCUMENT", "DOCUMENT");
         * ```
         */
    ...
    var protoSource =
    {
         ...
         *
         * @member {string[]} JSDekrakenFuck.Feature#canonicalNames
         */
         ...
         *
         * @member {string|undefined} JSDekrakenFuck.Feature#description
         */
         ...
         *
         * @member {boolean} JSDekrakenFuck.Feature#elementary
         */
         ...
         * aliases.
         *
         * @member {string[]} JSDekrakenFuck.Feature#elementaryNames
         */
         ...
         *
         * @function JSDekrakenFuck.Feature#includes
         *
         * @param {...(FeatureElement|CompatibleFeatureArray)} [feature]
         *
         * @returns {boolean}
        ...
        function (recurseTimes, ctx)
        {
            ...
            var result = ctx.stylize(str, 'JSDekrakenFuck-feature');
            return result;
        },
         ...
         *
         * @member {string|undefined} JSDekrakenFuck.Feature#name
         */
         ...
         * worker.
         *
         * @function JSDekrakenFuck.Feature#restrict
         *
         ...
         * </dl>
         *
         * @param {JSDekrakenFuck.Feature[]} [engineFeatureObjs]
         ...
         *
         * @returns {JSDekrakenFuck.Feature}
         * A feature object.
         */
         ...
         *
         * @function JSDekrakenFuck.Feature#toString
         *
         * @returns {string}
...
// As of version 2.1.0, definitions are interpreted using JSDekrakenFuck's own express parser, which can
...
(function ()
{
     ...
     *
     * @function JSDekrakenFuck.encode
     *
     * @param {string} input
     ...
     *
     * @param {FeatureElement|CompatibleFeatureArray} [options.features=JSDekrakenFuck.Feature.DEFAULT]
     * <p>
     * Specifies the features available in the engines that evaluate the encoded output.</p>
     * <p>
     * If this parameter is unspecified, [`JSDekrakenFuck.Feature.DEFAULT`](Features.md#DEFAULT) is
    ...
    /** @namespace JSDekrakenFuck */
    JSDekrakenFuck = assignNoEnum({ }, { Feature: Feature, encode: encode });
    ...
    if (typeof self !== 'undefined')
        self.JSDekrakenFuck = JSDekrakenFuck;

    // istanbul ignore else
    if (typeof module !== 'undefined')
        module.exports = JSDekrakenFuck;
}
)();
...
if (typeof DEBUG === 'undefined' || /* istanbul ignore next */ DEBUG)
{
    (function ()
    {
        ...
        assignNoEnum(JSDekrakenFuck, { debug: debug });
    }
    )();
}
